...
function Population(){
  ...
  //Select two parents from mating pool and create child
...
//Create DNA with random vectors initially
function DNA(genes){
  if (genes){
    this.genes = genes;
  }else{
...
function Rocket(dna){
  ...
  //Apply given force vector to rocket instance
  this.applyForce = function(force){
    this.acc.add(force);
  }

  //Calculate fitness with smaller distance to target giving
  //larger fitness.
  ...
  //apply velocity and acceleration to rocket
